...
export type IndexPageQuery = { allPrismicBlog: { group: Array<Pick<PrismicBlogGroupConnection, 'fieldValue'>> } };

export type TotLifePageQueryVariables = Exact<{ [key: string]: never; }>;


export type TotLifePageQuery = { allPrismicBlog: { edges: Array<{ node: Pick<PrismicBlog, 'id'> }> } };
...
export type TopicPageQuery = { allPrismicBlog: { edges: Array<{ node: Pick<PrismicBlog, 'id'> }> } };
